import 'package:cinmood_app/HomePagetwo.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [  const SizedBox(height: 100),
            ...
            // النص
            const Text(
              'جاهز تكتشف الفيلم او المسلسل اللي يفهمك؟',
              style: TextStyle(
            ...
            Align(
              ...
              child: IconButton(
                icon: const Icon(Icons.arrow_forward_ios, color: Color(0xFF030340), size: 20),
                onPressed: () {
                  Navigator.push(
                    context,
